...
//#JSCOVERAGE_ENDIF
		...
		_create: function () {
			...
			self._inputDate    = $("<input type=\"text\" class=\"date\"    value=\"" + self._formatNumber(self.options.date.getDate())       + "\" maxlength=\"2\"/>");
			self._inputMonth   = $("<input type=\"text\" class=\"month\"   value=\"" + self._formatNumber(self.options.date.getMonth() + 1)  + "\" maxlength=\"2\"/>");
			self._inputYear    = $("<input type=\"text\" class=\"year\"    value=\"" + self._formatNumber(self.options.date.getFullYear())   + "\" maxlength=\"4\"/>");
			self._inputHours   = $("<input type=\"text\" class=\"hours\"   value=\"" + self._formatNumber(self.options.date.getHours())      + "\" maxlength=\"2\"/>");
			self._inputMinutes = $("<input type=\"text\" class=\"minutes\" value=\"" + self._formatNumber(self.options.date.getMinutes())    + "\" maxlength=\"2\"/>");
			self._inputs = [self._inputDate, self._inputMonth, self._inputYear, self._inputHours, self._inputMinutes];
